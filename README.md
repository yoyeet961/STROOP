...
Dark mode was made using modified [DarkModeForms](https://github.com/BlueMystical/Dark-Mode-Forms). Select the bottom option after pressing the settings icon on the top right to toggle dark mode.
